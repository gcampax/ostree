  ...
  for (i = 0; i < n; i++)
    {
      ...
      if (!fetch_and_store_metadata (pull_data, meta_checksum, OSTREE_OBJECT_TYPE_DIR_META,
                                         ...
                                         GError      **error)
{
  ...
  if (!fetch_and_store_metadata (pull_data, tree_meta_checksum, OSTREE_OBJECT_TYPE_DIR_META,
                                 NULL, cancellable, error))
    goto out;
